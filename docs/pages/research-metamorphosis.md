---
layout: selfdriven
title: Societal Metamorphosis - Research - selfdrivenAI
subtitle: "Do the rules for the Caterpillar apply to the Butterfly?"
tags:
  - metamorphosis
  - societal-transition
  - transformation
  ...
  - future
summary: >
  A thought paper exploring whether the logics and rules of industrial
  society (the caterpillar) still apply in a rapidly transforming
  civilisation (the butterfly).
permalink: /research/metamorphosis/
---
...
- emerging models start as fringe
- incumbents identify them as threats
- networks form among the “new”
- the old system becomes irrelevant before it becomes extinct
...
- low consumption, high mobility
- co-evolution with ecosystems
- attraction instead of aggression
- exploration instead of optimisation
...
In many cases: **no.**
- Growth → becomes expansion of capability, not extraction
- Value → moves from resources to relationships
- Power → decentralises into networks
- Security → shifts from borders to interdependence
